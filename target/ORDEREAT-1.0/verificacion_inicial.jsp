<%-- 
    Document   : verificacion_inicial
    Created on : 20/11/2021, 07:02:16 PM
...
<%--<%
    ...
    neg2 = (MNegocio) sesionneg.getAttribute("Previo");
    if(neg2 == null){
        %>
...
<body>
    <div class="home_content">
        <a href="index.html"><i class='regreso bx bx-left-arrow-alt'><p class="at">Regresar</p></i></a> 
        ...
        <div class="container">
            ...
            <div class="content">
              <form method="post" action="Validar_Token_Inicial">
